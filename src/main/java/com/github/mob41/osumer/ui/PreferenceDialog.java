...
public class PreferenceDialog extends JDialog {
    ...
    public PreferenceDialog() {
        ...
        contentPanel.setLayout(new BorderLayout(0, 0));
        {
            ...
            panel_8.setBorder(new TitledBorder(null, "Getting started", TitledBorder.LEADING, TitledBorder.TOP, null, null));
                ...
                gl_mainPanel.createParallelGroup(Alignment.LEADING)
                    .addGroup(gl_mainPanel.createSequentialGroup()
                        ...
                        .addGroup(gl_mainPanel.createParallelGroup(Alignment.LEADING)
                            ...
                            .addGroup(gl_mainPanel.createSequentialGroup()
                                .addComponent(lblUiSkin)
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(uiSkinBox, GroupLayout.PREFERRED_SIZE, 215, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(ComponentPlacement.RELATED)
                ...
                gl_mainPanel.createParallelGroup(Alignment.LEADING)
                    .addGroup(gl_mainPanel.createSequentialGroup()
                        ...
                        .addGroup(gl_mainPanel.createParallelGroup(Alignment.BASELINE)
                            .addComponent(lblUiSkin)
                            .addComponent(uiSkinBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnApply))
            ...
            JLabel lblIfYouAre = new JLabel("If you are new to here, or old users from v1, please take a short look of the Getting Started guide!");
                ...
                gl_panel_8.createParallelGroup(Alignment.LEADING)
                    .addGroup(gl_panel_8.createSequentialGroup()
                        ...
                        .addGroup(gl_panel_8.createParallelGroup(Alignment.LEADING)
                            ...
                            .addComponent(chckbxShowGettingStarted, GroupLayout.DEFAULT_SIZE, 728, Short.MAX_VALUE)
            ...
            gl_panel_8.setVerticalGroup(
                gl_panel_8.createParallelGroup(Alignment.LEADING)
                    .addGroup(gl_panel_8.createSequentialGroup()
                        .addComponent(lblWelcomeToOsumer, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(lblIfYouAre)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(chckbxShowGettingStarted)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(btnShowGuide_1)
            ...
            mainPanel.setLayout(gl_mainPanel);
            {
                ...
                panel_3.setBorder(new TitledBorder(null, "osumerExpress Installation Status (Browser Hooker)", TitledBorder.LEADING, TitledBorder.TOP, null, null));
                ...
                JCheckBox chckbxDisabledDaemon = new JCheckBox("Daemon Disabled (Uses traditional v1 start-on-command instead of daemon socket call, comparatively slower)");
                    ...
                    gl_panel.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_panel.createSequentialGroup()
                            ...
                            .addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
                                ...
                                .addComponent(chckbxDisabledredirectAll, GroupLayout.DEFAULT_SIZE, 760, Short.MAX_VALUE)
                                .addComponent(chckbxRunAsDaemon, GroupLayout.DEFAULT_SIZE, 760, Short.MAX_VALUE)
                                .addComponent(chckbxDisabledDaemon, GroupLayout.DEFAULT_SIZE, 760, Short.MAX_VALUE))
                            .addContainerGap())
                );
                ...
                JLabel lblPleaseSetosumerexpress = new JLabel("Hint: Please set \"osumerExpress\" as default browser in order to receive beatmap URLs.");
                
                JButton btnShowGuide = new JButton("Show Guide");
                
                JLabel lblPleaseRestartOsumer = new JLabel("Please restart osumer2 with administrative priviledges to have un/installations ");
                    ...
                    gl_panel_3.createParallelGroup(Alignment.TRAILING)
                        .addGroup(gl_panel_3.createSequentialGroup()
                            ...
                            .addGroup(gl_panel_3.createParallelGroup(Alignment.TRAILING)
                                .addComponent(btnInstallOsumerexpress, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 722, Short.MAX_VALUE)
                                .addComponent(lblPleaseRestartOsumer, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 722, Short.MAX_VALUE)
                                .addGroup(Alignment.LEADING, gl_panel_3.createSequentialGroup()
                                    .addComponent(lblPleaseSetosumerexpress, GroupLayout.DEFAULT_SIZE, 609, Short.MAX_VALUE)
                                    .addPreferredGap(ComponentPlacement.RELATED)
                                    .addComponent(btnShowGuide))
                                .addGroup(Alignment.LEADING, gl_panel_3.createSequentialGroup()
                                    .addComponent(lblStatus)
                                    .addPreferredGap(ComponentPlacement.RELATED)
                                    .addComponent(lblUnknown, GroupLayout.DEFAULT_SIZE, 676, Short.MAX_VALUE)))
                            .addContainerGap())
                );
                    ...
                    gl_panel_1.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_panel_1.createSequentialGroup()
                            ...
                            .addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING, false)
                                ...
                                .addComponent(btnRmv, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addPreferredGap(ComponentPlacement.RELATED)
                    ...
                    gl_panel_2.createParallelGroup(Alignment.LEADING)
                        .addGroup(Alignment.TRAILING, gl_panel_2.createSequentialGroup()
                            ...
                            .addGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING)
                                .addComponent(lblLoggedInAs, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)
                                .addComponent(btnRemoveCredentials, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)
                                .addComponent(btnClickHereTo, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE))
                            .addContainerGap())
                );
                gl_panel_2.setVerticalGroup(
                    gl_panel_2.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_panel_2.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(lblLoggedInAs, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(ComponentPlacement.RELATED)
                            .addComponent(btnClickHereTo, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addPreferredGap(ComponentPlacement.RELATED)
                            .addComponent(btnRemoveCredentials, GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                            .addContainerGap())
                );
                ...
                public void actionPerformed(ActionEvent e) {
                    if (chckbxEnableMassiveDownloading.isSelected()){
                        int option = JOptionPane.showOptionDialog(PreferenceDialog.this, 
                                ...
                                + " get yourself into a lawsuit.\n\nAre you sure to continue?", "Warning", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, null, 0);
                        ...
                        .addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
                            .addGroup(gl_panel.createSequentialGroup()
                                ...
                                .addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
                                    ...
                                    .addComponent(spinner_1, GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE))
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
                                    .addComponent(lblMs)
            ...
            JPanel panel_2 = new JPanel();
            panel_2.setBorder(new TitledBorder(null, "Frequency on checking updates", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            
            JPanel panel_3 = new JPanel();
            panel_3.setBorder(new TitledBorder(null, "Update branch", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            
            JPanel panel_4 = new JPanel();
            panel_4.setBorder(new TitledBorder(null, "Comparison algorithm", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            panel_5.setBorder(new TitledBorder(null, "Down-grade software", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            GroupLayout gl_panel_1 = new GroupLayout(panel_1);
            gl_panel_1.setHorizontalGroup(
                gl_panel_1.createParallelGroup(Alignment.LEADING)
                    .addGroup(Alignment.TRAILING, gl_panel_1.createSequentialGroup()
                        ...
                        .addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
                            ...
                            .addComponent(chckbxAutomaticallyAcceptCritical, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 764, Short.MAX_VALUE)
                            ...
                            .addComponent(chckbxDownloadAndApply, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 760, Short.MAX_VALUE)
                            .addComponent(btnCheckUpdateNow, Alignment.LEADING))
                        .addContainerGap())
            );
            gl_panel_1.setVerticalGroup(
                gl_panel_1.createParallelGroup(Alignment.LEADING)
                    .addGroup(gl_panel_1.createSequentialGroup()
                        ...
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(btnCheckUpdateNow)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(panel_5, GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
                        .addContainerGap())
            );
            
            JLabel lblWarningDowngradingOsumer = new JLabel("WARNING: Downgrading osumer may result in function loss or ocurrance of bugs.");
            ...
            JLabel lbldowngradingToVersions = new JLabel("*Downgrading to versions older than 1.0.0-snapshot-b1 will loss updater functions.");
            
            JLabel lbldisableAutoInstall = new JLabel("***Disable auto install patches and critical updates if install older v2.x.x series");
            ...
            gl_panel_5.setVerticalGroup(
                gl_panel_5.createParallelGroup(Alignment.LEADING)
                    .addGroup(gl_panel_5.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(lblWarningDowngradingOsumer)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        ...
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(lbldowngradingToVersions)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(lbldisableAutoInstall)
                        .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            );
            ...
            panel_7.setBorder(new TitledBorder(null, "On-login password", TitledBorder.LEADING, TitledBorder.TOP, null, null));
            ...
            JCheckBox chckbxEnabledusedAs = new JCheckBox("Enabled (Used as encryption with account osu! username and password)");
                ...
                gl_panel_7.createParallelGroup(Alignment.LEADING)
                    .addGroup(Alignment.TRAILING, gl_panel_7.createSequentialGroup()
                        ...
                        .addGroup(gl_panel_7.createParallelGroup(Alignment.TRAILING)
                            .addComponent(chckbxAskOnStartup, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 736, Short.MAX_VALUE)
                            .addComponent(chckbxEnabledusedAs, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 736, Short.MAX_VALUE))
                        .addContainerGap())
            );
            gl_panel_7.setVerticalGroup(
                gl_panel_7.createParallelGroup(Alignment.LEADING)
                    .addGroup(gl_panel_7.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(chckbxEnabledusedAs)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(chckbxAskOnStartup)
